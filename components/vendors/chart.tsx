...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: moderateScale(20) },
  count: { fontSize: normalizeFont(14), fontWeight: "bold", color: "#000" },
  small: { fontSize: normalizeFont(12), fontWeight: "normal", color: "#666" },
  growth: { fontSize: normalizeFont(12), fontWeight: "600", marginTop: moderateScale(4) },
